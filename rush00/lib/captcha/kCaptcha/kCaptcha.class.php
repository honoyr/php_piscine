...
# KCAPTCHA PROJECT VERSION 1.2.1
...
# See kcaptcha.config.php for customizing

/*                                            
    modified for skillz project by surgeon
    http://skillz.ru/
*/

class kCaptcha extends aCaptcha
{
    // generates image
    function render()
    {
        require(dirname(__FILE__).'/kCaptcha.config.php');
        $this->symbols=$allowed_symbols;
        $this->length=$length;
        $keystring=$this->getCode();
        $fonts=array();
        ...
        $this->keystring= strtolower($keystring);
