<form action="admin/pano/resize" method="post" enctype="multipart/form-data">
    <div class="typPopTitle">Шаг 1. Загрузка картинок для баннера.</div>
    <!-- BEGIN img_exists -->
    <div class="Img" style="margin-bottom:10px">
        <img src="images/pano/temp/{KEY}?{RAND}" alt="" id="cropbox"/>
    </div>
    <!-- END img_exists -->
    ...
    <div class="Buttons">
        <span class="oFileLink upload"><i>Загрузить картинку</i><input type="file" name="file" size="70" href="admin/pano/upload"/></span>
        <!-- BEGIN img_exists -->
