<form action="admin/news/edit/{ID}" method="post" enctype="multipart/form-data">
<div class="oT2">
<table><tbody>
    <tr>
    ...
    <tr>
        ...
        <td><div class="oCheckboxes">
            <ins><input type="checkbox" name="enable" id="showBroker"/><label for="showBroker">Показывать новость на сайте</label></ins>
        </div></td>
    </tr>
    <tr>
