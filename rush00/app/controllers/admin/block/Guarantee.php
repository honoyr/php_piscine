 ...
 */
class App_Admin_Block_Guarantee extends Controller
{
    ...
    {
        if (is_file(DIR_IMAGES.'/'.self::DIR_PICTURES.'/guarantee.png'))
        {
    ...
    function settingsAction(array $params)
    {
        ...
        $form = $this->load->form('admin/stuff/guarantee');
        if (!$form->isSubmit())
